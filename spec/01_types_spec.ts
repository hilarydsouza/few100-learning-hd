...
describe('types', () => {
    describe('declaring variables', () => {
        ...
        it('a const keyword', () => {
            ...
            expect(favoriteNumbers).toEqual([108, 2, 3, 4, 5, 6]);
        ...
        it('why using var is bad for your health', () => {
            ...
            expect(message).toBe('Old enough!');   //shouldnt be valid due to scope of 'message' declared with var
        });
    });
...
line
    ...
    describe('arrays', () => {
        it('has them', () => {
            ...
            const lotterNumbers: Array<number> = [];
